...
Estado de lanzamiento 2026-09-03: versión `1.0.0` (`versionCode=1`) migrada a `compileSdk/targetSdk 36`, AGP 8.13.2 y Gradle 8.13 para cumplir el requisito vigente de aplicaciones nuevas en Google Play. Huawei VNS-L53 validó instalación, arranque, marca LED sin recorte y gesto de perilla. Se prepararon notas, checklist y dos anuncios verticales. El AAB final `AudioBooster_v1.0.0_1.aab` fue firmado con una clave de carga dedicada y validado por `jarsigner` y Bundletool. La clave no forma parte de Git; su copia cifrada de recuperación se mantiene separada y la contraseña nunca debe guardarse junto a ella.
